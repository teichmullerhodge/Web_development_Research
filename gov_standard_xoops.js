...
function InserirPagina_recebe2(){
    window.opener.document.getElementById(id).innerHTML = url_decode(window.opener.obj.responseText);
}
...
var servidor = "http://www.redeescola.seed.pr.gov.br";
...
{
    // Monta array dos dados enviados pela requisicao
    var dados = new Array(valor);
    // Chama requisicao
    Requisition(id='municipio',url=servidor+'/modules/instalacao/include/nucleo.php',funcao='InserirPagina_recebe',dados);
}

function Municipio2(valor)
{
    // Monta array dos dados enviados pela requisicao
    var dados = new Array(valor,'2');
    // Chama requisicao
    Requisition(id='municipio',url=servidor+'/modules/instalacao/include/nucleo.php',funcao='InserirPagina_recebe',dados);
}

function Escola(nre,municipio)
{
    // Monta array dos dados enviados pela requisicao
    var dados = new Array(''+nre,municipio);

    // Chama requisicao
    Requisition(id='escola',url=servidor+'/modules/instalacao/include/escola.php',funcao='InserirPagina_recebe',dados);
}

function LoginExpresso(nre, municipio, escola)
{
    // Monta array dos dados enviados pela requisicao
    var dados = new Array(''+nre, ''+municipio, ''+escola);
    
    // Chama requisicao
    Requisition(id='txLdapLogin',url=servidor+'/modules/instalacao/include/login.php',funcao='InserirPagina_recebe',dados);
}
